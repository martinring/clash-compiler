...
type Configuration = (Unsigned 16, Unsigned 16, Unsigned 16, Vec 256 (Vec 256 (Unsigned 16)))
...
type ControllerState = Vec 256 (Bool, Unsigned 16)

controllerT :: ControllerState -> (Configuration, Vec 256 (Unsigned 16)) -> (ControllerState, Vec 256 Bool)
...
controller :: Signal (Configuration, Vec 256 (Unsigned 16)) -> Signal (Vec 256 Bool)
controller = mealy controllerT $ replicate SNat (False,0)

configuredController :: Signal (Bool, Configuration, Vec 256 (Unsigned 16)) -> Signal (Vec 256 Bool)
